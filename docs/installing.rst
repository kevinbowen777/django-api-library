...
To install the ``django-api-library`` project, run the following command in your terminal:
...
.. code-block:: console
   ...
   $ docker run -it django-api-library-web bash
...
To run django-api-library, locally, enter the following on the command line:
